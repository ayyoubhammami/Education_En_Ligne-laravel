    ...
    <!-- Content Header (Page header) -->
        ...
        <div class="row" style="margin-top: 50px;">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-success" href="{{ route('themes.create') }}"> Créer  nouveau thème</a>
                    </div>
                </div>
            </div>
            ...
            @endif
              ...
              <tr>
                            ...
                            <td>{{ $theme->nom }}</td>
                <td>
                    <a class="btn btn-warning" title="Modifier"  href="{{ route('themes.edit',$theme->id) }}"><i class="fa fa-pencil"></i></a>
                    
                
                      <a title="supprimer" type="button" class="btn btn-danger " data-toggle="modal" data-target="#edit{{ $theme->id }}" id="edit{{ $theme->id }}"><i class="fa fa-trash-o" ></i></a>
                 ...
                 <div class="modal fade" id="edit{{ $theme->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h4 class="modal-title" id="myModalLabel">Voulez vous supprimer ce theme</h4>
      </div>
