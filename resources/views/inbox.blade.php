    ...
    <section class="sidebar" style="background-color:#004157; ">
      ...
      @canDo('liste_cours')
       ...
       @canDo('lise_roles')
        ...
        <li >
          <a href="/Event">
            <i class="fa fa-calendar"></i> <span>Ajouter évènnement</span>
          </a>
        </li>
        @endcanDo 
        @canDo('passer_ex')
        ...
        <li>
              ...
              <a href="/eventtt">
                <i class="fa fa-calendar"></i> <span>Evènnement</span>
              </a>
            </li>
        @endcanDo 
        @canDo('liste_mail')
...
<!-- Main content -->
    <section class="content">
      <div class="row" style="margin-top: 50px;">
        <div class="col-md-3">
          <a href="compose" class="btn btn-primary btn-block margin-bottom">Rediger</a>
        ...
        <div class="col-md-9">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-hover table-responsive table-striped">
                <thead>
               ...
               <tbody>
                  ...
                  <tr> 
                    ...
                    <td>
                       ...
                       <a title="supprimer" type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#edit{{ $message->id }}" id="edit{{ $message->id }}"><i class="fa fa-trash-o" ></i></a>
                       

                    </td>
                    
                    <td class="mailbox-name">
                      @if(App\User::find($message->sender)->role_id == 3)
                        <i class="fa fa-star text-yellow"></i>&nbsp;
                      @endif
                      @if(App\User::find($message->sender)->role_id == 2)
                        <i class="fa fa-star text-default"></i>&nbsp;
                      @endif
                      @if(App\User::find($message->sender)->role_id == 1)
                        <i class="fa fa-star text-yellow"></i>&nbsp;
                      @endif
                      <a href="{{route('read',['id'=>$message->id])}}">{{App\User::find($message->sender)->name}}</a><br><small>{{App\User::find($message->sender)->email}}</small></td>
                    <td class="mailbox-subject "><b>{{$message->subject}}</b>
                    </td>
                    
                    <td class="mailbox-date">{{\Carbon\Carbon::createFromTimeStamp(strtotime($message->created_at))->diffForHumans() }}</td>
                  </tr>
                  @endif
                  <div class="container">
  

<div class="modal fade" id="edit{{ $message->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h4 class="modal-title" id="myModalLabel">Voulez vous supprimer ce message</h4>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn  btn-default" data-dismiss="modal">Fermer</button>
         <a  href="{{route('remouve',['id'=>$message->id])}}" title="supprimer" type="button" class="btn btn-danger "><i class="fa fa-trash-o"></i></a>
      </div>
    </div>
  </div>
</div>
...
<!-- jQuery 3 -->
<script src="{{ url('/') }}/admin/adminLTE/bower_components/jquery/dist/jquery.min.js"></script>
<!-- Bootstrap 3.3.7 -->
<script src="{{ url('/') }}/admin/adminLTE/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
<!-- DataTables -->
<script src="{{ url('/') }}/admin/adminLTE/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="{{ url('/') }}/admin/adminLTE/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
<!-- SlimScroll -->
<script src="{{ url('/') }}/admin/adminLTE/bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>
...
<!-- FastClick -->
<script src="{{ url('/') }}/admin/adminLTE/bower_components/fastclick/lib/fastclick.js"></script>
<!-- AdminLTE App -->
