          ...
          <div class="col-md-10  toppad  col-md-offset-1 " >
            ...
            <div class="row" style="margin-top: 50px;">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-success" href="{{ route('Examens.create') }}"> Créer Nouvel examen</a>
                    </div>
                    @endif
                </div>
            </div>
...
@if(Auth::user()->id==$examen->user_id)
 <tr>
                 <td>{{ $examen->titre }}</td> 
                 <td>{{ $examen->publier }}</td>
                 <td>{{ $examen->user->name}}</td>
        <td>
            @if(Auth::user()->role_id==3)
            <a class="btn btn-warning" title="Modifier"  href="{{ route('Examens.edit',$examen->id) }}"><i class="fa fa-pencil"></i></a>
            @endif
        
 <a title="supprimer" type="button" class="btn btn-danger " data-toggle="modal" data-target="#edit{{ $examen->id }}" id="edit{{ $examen->id }}"><i class="fa fa-trash-o" ></i></a>
            @if(Auth::user()->role_id==1)
              <a class="btn btn-info" title="Publier" href="{{ route('addExam',$examen->id) }}"><i class="fa fa-check-square-o"></i>  </a>
              <a class="btn btn-primary" title="Masquer" href="{{ route('Remouve',$examen->id) }}"> <i class="fa fa-eye-slash"></i></a>
            @endif
               <a class="btn btn-default" title="Consulter" href="{{route('passer',['id'=>$examen->id])}}"><i class="fa fa-eye"></i></a>
    ...
    @endif
                 ...
                 <div class="modal fade" id="edit{{ $examen->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h4 class="modal-title" id="myModalLabel">Voulez vous supprimer cet  Examen</h4>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn  btn-default" data-dismiss="modal">Fermer</button>
                      {!! Form::open(['method' => 'DELETE','route' => ['Examens.destroy', $examen->id],'style'=>'display:inline']) !!}
...
@if(Auth::user()->role_id==1)
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h4 class="modal-title" id="myModalLabel">Voulez vous supprimer ce examen</h4>
      </div>
      <div class="modal-body">
 ...
 <footer class="main-footer">
    ...
    <strong>Copyright &copy; wecode <a href="https://adminlte.io">wecode land</a>.</strong> Tous les droits réservé.
  </footer>
