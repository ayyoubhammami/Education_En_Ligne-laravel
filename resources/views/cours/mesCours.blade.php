    ...
    <!-- Content Header (Page header) -->
        ...
        <div class="row">
          <div class="col-md-10  toppad  col-md-offset-1 " >
            ...
            <div class="full" style="margin-top: 20px; z-index:1000; ">
                <h1 class="main-title">
                    <span class="span1">Mes Statistiques </span>
                    <span class="span2">Nembre des cours | Payements </span>
                    <span class="span3">(par Année)</span>
                </h1>
            </div>

              <style class="cp-pen-styles">.morris-hover {
                position:absolute;
              }
                ...
                <div class="row">
                  ...
                  function barChart() {
                    ...
                    @foreach(App\Cour::all() as $cour) 
                     @if($cour->user->id == Auth::user()->id)
                      data: [
                        { y: "{{$cour->created_at->format('Y')}}", a: {{$cour->sum('paye')}}, b: {{App\Cour::where('user_id', Auth::user()->id)->count()}} },
                  ...
                  //# sourceURL=pen.js
                    ...
                    <div class="row" style="margin-top: 50px;">
                            <div class="col-lg-12 margin-tb">
                                ...
                                <div class="pull-right">
                                    <a class="btn btn-success" href="{{ route('addCour') }}"> Ajouter un nouveau cours</a>
                                </div>
                                @endif
                            </div>
                        </div>
                       @if ($message = Session::get('success'))
                                ...
                                <div class="box-body">
                                  <table id="example2" class="table table-bordered table-responsive table-striped">
                                    ...
                                    <tr style="background-color: #DCE6EC;">
                                      ...
                                      <th>Prix </th>
                                      <th>Date</th>
                                      <th width="80">Nember de payment </th>
                                      <th>Action</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                        ...
                        @if($cour->user->id == Auth::user()->id) 
                            ...
                            <td>
                                ...
                                <a class="btn btn-warning" title="Modifier"  href="{{ route('cours.edit',$cour->id) }}"><i class="fa fa-pencil"></i></a>
                                <a class="btn btn-primary" title="Voir" href="{{route('video',['id'=>$cour->id])}}" ><i class="fa fa-eye"></i></a>
                                 <a title="supprimer" type="button" class="btn btn-danger " data-toggle="modal" data-target="#edit{{ $cour->id }}" id="edit{{ $cour->id }}"><i class="fa fa-trash-o" ></i></a>
                            </td>
                                    </tr>
                         @endif
                 ...
                 <div class="modal fade" id="edit{{ $cour->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h4 class="modal-title" id="myModalLabel">Voulez vous supprimer ce cour</h4>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn  btn-default" data-dismiss="modal">Fermer</button>
          {!! Form::open(['method' => 'DELETE','route' => ['cours.destroy', $cour->id],'style'=>'display:inline']) !!}
              ...
              {!! Form::close() !!}
                        ...
                        <!-- /.content -->
                         ...
                         <footer class="main-footer">
                           <strong>Copyright &copy; wecode <a href="">wecode land</a>.</strong> Tous les droits réservé.
                          </footer>
