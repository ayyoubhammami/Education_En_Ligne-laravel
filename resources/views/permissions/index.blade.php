  ...
  <div class="content-wrapper">
   ...
   <div class="row" style="margin-top: 50px;">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success" href="{{ route('permissions.create') }}">Créer Nouvelle Permission</a>
            </div>
        </div>
    </div>
          ...
          <div class="box">
            ...
            @foreach ($permissions as $key => $permission) 
                <tr>
                  ...
                  <td>
                     <a class="btn btn-warning" title="Modifier"  href="{{ route('permissions.edit',$permission->id) }}"><i class="fa fa-pencil"></i></a>
                     <a title="supprimer" type="button" class="btn btn-danger " data-toggle="modal" data-target="#edit{{ $permission->id }}" id="edit{{ $permission->id }}"><i class="fa fa-trash-o" ></i></a>
                  </td>
                </tr>
                 ...
                 <div class="modal fade" id="edit{{ $permission->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
